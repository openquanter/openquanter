...
CRATES=(
  ...
  "oq-hash|SHA-256 and CRC-32, shared by the journal, capture and parity"
  ...
  "oq-book|Order book rebuilt from incremental depth, shared by capture and matching"
  "oq-ingest|Captured venue archives folded into the tick format the engine replays"
